...
public:
    ...
    void record_shadow_map_generation_commands_in_command_list(std::shared_ptr<Scene> scene,
...
private:
    void create_root_signature(ComPtr<ID3D12Device> device);
    ...
    int m_root_param_index_of_matrices;
